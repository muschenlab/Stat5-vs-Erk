...
# load mutation data
mut <- readxl::read_excel("Supplementary-Table 1_2019-11-21.xlsx")[,-c(1:10)]
...
genelist <- list(STAT = c("CRLF2","IL3RA","IL7R","PDGFRA","PDGFRB","EPOR",
                          "ABL1","JAK1","JAK2","JAK3","TYK2","STAT5A"),
                 ERK = c("NRAS","KRAS","PTPN11","NF1","BRAF, RAF","FLT3"))
